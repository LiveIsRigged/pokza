...
function PostCardInner({
  ...
  /** Ouvre le récit du coup en phrases, à copier ailleurs (cf. `MainEnTexteScreen`). */
  ...
  //
  // « La main en texte » figure dans les DEUX listes, et c'est la seule entrée commune : elle ne
  // change rien, ni à la main ni au compte de personne. Sur sa propre main elle se range entre
  // « Dupliquer » et « Supprimer » — juste après l'autre façon d'emporter la main, juste avant
  // l'irréversible. Sur celle d'un autre elle ouvre la liste : il n'y a pas d'entre-deux où la
  // mettre, et la glisser sous « Signaler » et « Bloquer » enterrerait le seul geste anodin des
  // trois.
  ...
  return (
    <View style={styles.card}>
      ...
      */}
      ...
      <MainEnTexteScreen visible={texteOuvert} partie={post} onFermer={() => setTexteOuvert(false)} />
      {isOwnPost && onCorrect && (
        <ConfirmSheet
